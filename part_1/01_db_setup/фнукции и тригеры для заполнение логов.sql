...
$func$
	...
	ПРИМЕЧАНИЕ: в задаче 1.2  данная фукция будет изменена:
		...
		- изменится структура функции, чтобы обарбатывать также операцию delete.
		- добавится блок, чтобы получиить pk_date и pk_second_part у витрин из слоя DM с учётом операций удаления или вставки
	*/
